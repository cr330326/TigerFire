...
| 类型 | 文件名 | 用途 | 尺寸 |
|------|--------|------|------|
| 背景 | `bg_map.png` | 地图背景 | 1920×1080 |
| 背景 | `bg_firestation.png` | 消防站背景 | 1920×1080 |
| 背景 | `bg_school.png` | 学校背景 | 1920×1080 |
| 背景 | `bg_forest.png` | 森林背景 | 1920×1080 |
| 图标 | `icon_badge_base.png` | 徽章基础图标 | 512×512 |
| UI | `btn_parent.png` | 家长模式按钮 | 200×200 |
| UI | `btn_collection.png` | 收藏按钮 | 200×200 |
